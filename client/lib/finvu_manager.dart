...
class FinvuManager {
  ...
  Future<void> revokeConsent(String consentId, FinvuUserConsentInfo consent, AccountAggregator? accountAggregator, FIPReference? fipDetails) {
    ...
    final nativeAA = accountAggregator != null ? NativeAccountAggregator(id: accountAggregator.id!) : null;
    final nativeFipDetails = fipDetails != null ? NativeFIPReference(fipId: fipDetails.fipId, fipName: fipDetails.fipName) : null;

    return _nativeFinvuManager.revokeConsent(nativeConsent, nativeAA, nativeFipDetails).catchError(
          (e) => throw FinvuException.from(e),
          test: _platformExceptionTest,
        );
  }
