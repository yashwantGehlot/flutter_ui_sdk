...
import 'package:finvu_flutter_sdk/features/account_data_fetch/recurring_deposits/recurring_deposit_transaction_detail.dart';
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

Widget recurringDepositAccountItem(
      ...
      subtitle: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                "₹${account.recurringDeposit?.summary.currentValue.toString()}",
                style: const TextStyle(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            RecurringDepositTransactionDetail(account: account),
                      ),
                    );
                  },
