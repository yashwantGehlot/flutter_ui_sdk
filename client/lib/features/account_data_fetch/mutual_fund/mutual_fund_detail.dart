...
import 'package:finvu_flutter_sdk/features/account_data_fetch/mutual_fund/mutual_fund_holding_tab.dart';
import 'package:finvu_flutter_sdk/features/account_data_fetch/mutual_fund/mutual_fund_transaction_tab.dart';
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class MutualFundDetail extends BasePage {
  const MutualFundDetail({super.key, required this.account});
  final FIAccount account;

  @override
  State<MutualFundDetail> createState() => _MutualFundDetailState();

  @override
  String routeName() {
    return FinvuScreens.mutualFundDetailPage;
  }
}

class _MutualFundDetailState extends BasePageState<MutualFundDetail> {
  @override
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child: TabBarView(
                            children: [
                              MutualFundHoldingTab(
                                account: widget.account,
                              ),
                              MutualFundTransactionTab(
                                account: widget.account,
                              )
                            ],
                          ),
