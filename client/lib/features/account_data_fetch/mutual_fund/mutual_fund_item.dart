...
import 'package:finvu_flutter_sdk/features/account_data_fetch/mutual_fund/mutual_fund_detail.dart';
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

Widget mutualFundItem(
      ...
      subtitle: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                "₹${account.mutualFund?.summary.currentValue.toString()}",
                style: const TextStyle(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MutualFundDetail(
                          account: account,
                        ),
                      ),
                    );
